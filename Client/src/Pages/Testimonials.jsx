...
const Testimonials = () => {
  return (
    <div className="max-w-screen mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8 font-primary text-white"  id="test" >
 
  <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <h2 className="text-center font-secondary text-3xl font-bold tracking-tight text-gray-200 sm:text-5xl">
    ...
    <div className="mt-8 [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8">
     ...
     data-aos-anchor-placement="center-center" >
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Aman Kumar</p>
            </div>
          </div>
     ...
     data-aos-anchor-placement="center-center" >
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            <img
              alt="Man"
              src="https://images.pexels.com/photos/6936177/pexels-photo-6936177.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
              className="h-14 w-14 rounded-full object-cover"
            />
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Neel gupta</p>
            </div>
          </div>
        ...
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Arushi Singh</p>
            </div>
          </div>
        ...
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Suyash Choudhary</p>
            </div>
          </div>
        ...
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Vineet Singh</p>
            </div>
          </div>
        ...
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Nisha Jain</p>
            </div>
          </div>
        ...
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Rahul meena</p>
            </div>
          </div>
        ...
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Sarvesh gupta</p>
            </div>
          </div>
        ...
        <blockquote className="rounded-lg bg-white/[.1] hover:bg-white/[.3] border border-white/[.05] p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-200">Aarush Kumar</p>
            </div>
          </div>
